parcelRequire = (function (e, r, t, n) {
...
})(
  {
          ...
          t = function (t, n, o) {
            return 'string' == typeof n
              ? (function (t, n) {
                  ...
                  if (!o) throw new Error('Element with selector ' + t + ' have not been founded');
                  if (!r) throw new Error('Element with selector ' + n + ' have not been founded');
                  var i = o.getBoundingClientRect(),
                    ...
                    f = c.width,
                    h = c.height;
                  return { x: a - u + e(f) + 'px', y: d - l + e(h) + 'px' };
                })(t, n)
              : 'string' == typeof (null == o ? void 0 : o.x) &&
                'string' == typeof (null == o ? void 0 : o.y)
              ? o
              : (function (t) {
                  var n = document.querySelector(t);
                  if (!n) throw new Error('Element with selector ' + t + ' have not been founded');
                  var o = n.getBoundingClientRect(),
                    r = o.left,
                    i = o.top,
                    u = o.width,
                    l = o.height;
                  return { x: r + e(u) + 'px', y: i + e(l) + 'px' };
                })(t);
          };
        function n(e) {
          var n = e.revealElementSelector,
            o = e.options,
            r = document.querySelector(n),
            i = !1,
            u = null,
            l = 0,
            c = l,
            a = t(n, null == o ? void 0 : o.anchorSelector, null == o ? void 0 : o.position),
            d = function () {
              r.style.clipPath = 'circle(' + c + 'px at ' + a.x + ' ' + a.y + ')';
            },
            f = function () {
              c += 0.08 * (l - c);
            },
            ...
            s = function () {
              f();
              var e = c - l > -2;
              i || h(), e ? v() : (d(), (u = requestAnimationFrame(s)));
            },
            p = function () {
              f();
              var e = Math.abs(c - l) < 2;
              i && h(), e ? v() : (d(), (u = requestAnimationFrame(p)));
            };
          return (
            d(),
            r.setAttribute('data-active', 'true'),
            {
              ...
              reveal: function () {
                i ||
                  ((a = t(
                    n,
                    null == o ? void 0 : o.anchorSelector,
    ...
    mZc6: [
      function (require, module, exports) {
        'use strict';
        var e = a(require('circular-revealer')),
          t = require('./constants');
        function a(e) {
        ...
        const s = (0, e.default)({
          ...
          options: { anchorSelector: '.nav-btn-js' },
        });
        t.actionBtn.addEventListener('click', () => {
          s.isRevealed()
            ? (s.hide(),
              t.actionBtn.setAttribute('data-open', !1),
              (t.search.style.display = 'block'),
              (t.searchPhotos.style.display = 'block'))
            : (s.reveal(),
              t.actionBtn.setAttribute('data-open', !0),
              (t.search.style.display = 'none'),
              (t.searchPhotos.style.display = 'none'));
        });
      },
      { 'circular-revealer': 'bFF3', './constants': 'MuPq' },
    ],
  },
  {},
  ['mZc6'],
...
//# sourceMappingURL=./burgerMenu.e81d11fa.js.map
